...
class SimpleBudgetApp(ctk.CTk):
    def __init__(self):
        ...
        ctk.CTkButton(top, text="Ustawienia", fg_color="transparent", hover_color="#111217", font=("Segoe UI", 14, "bold"), command=lambda: self.switch_view("Ustawienia")).pack(side="right", padx=(4, 4))
