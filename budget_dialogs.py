...
class AddTransactionDialog(ctk.CTkToplevel):
    def __init__(self, parent, accounts, tags, on_saved, transaction=None):
        ...
        self.tag_combo = ctk.CTkComboBox(self, variable=self.tag_var, values=[t['name'] for t in tags], fg_color="#2C2C2E", border_color="#3A3A3C", button_color="#3A3A3C", text_color="#FFFFFF", corner_radius=10, state="readonly")
